...
public class AppMain {
    public static void main(String[] args) {
        PrimaryNumbersGenerator firstGenerator = PrimaryNumbersGenerator.createNumberGenerator(0, 1000, "1st Generator");
        PrimaryNumbersGenerator secondGenerator = PrimaryNumbersGenerator.createNumberGenerator(1000, 2000, "2st Generator");
